package com.dada.banking_project.security;

import com.dada.banking_project.filters.CustomAuthenticationFilter;
import com.dada.banking_project.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(POST, "/api/transaction").hasAnyAuthority("ROLE_ADMIN")
